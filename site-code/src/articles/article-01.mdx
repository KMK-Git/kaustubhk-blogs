...
- Application resources. These resources are used for the actual website hosting (1, 2, and 3 in the above diagram). The code can be viewed [here](https://github.com/KMK-Git/kaustubhk-blogs/blob/main/cdk-code/application_stacks/static_website_stack.py). It is mainly based on an [AWS example](https://github.com/aws-samples/aws-cdk-examples/blob/master/typescript/static-site/static-site.ts).
